...
class _IndeterminateYaruLinearProgressIndicatorPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // final realStrokeWidth = size.height / 2;
    ...
    // final fillPaint = Paint()
    //   ..color = color.withOpacity(1 - speed)
    //   ..style = PaintingStyle.fill;
    // final strokePaint = Paint()
    //   ..color = color
    ...
    //   ..color = Colors.black.withOpacity(1 - speed)
    //   ..style = PaintingStyle.fill
    //   ..blendMode = BlendMode.dstOut;
    ...
    //       (strokeLength * i / 2 + (strokeLength * i * speed * 1.75));
    ...
    //   canvas.drawCircle(Offset(x2, y), realStrokeWidth * 2, invertPaint);
    //   canvas.drawCircle(Offset(x2, y), realStrokeWidth, fillPaint);
