...
// import 'package:flutter/cupertino.dart'; // Yaru change: bypass CupertinoSwitch
import 'package:flutter/foundation.dart';
import 'package:flutter/gestures.dart';
import 'package:flutter/material.dart';
import 'package:flutter/rendering.dart';

const double _kTrackHeight = 26.0; // Yaru change: bigger switch track
const double _kTrackWidth = 48.0; // Yaru change: bigger switch track
const double _kTrackRadius = _kTrackHeight / 2.0;
const double _kThumbRadius = 11.0; // Yaru change: bigger switch thumb
...
class YaruSwitch extends StatelessWidget {
  /// Creates a Yaru design switch (fully compatible with material one).
  ///
  /// The switch itself does not maintain any state. Instead, when the state of
  /// the switch changes, the widget calls the [onChanged] callback. Most widgets
  /// that use a switch will listen for the [onChanged] callback and rebuild the
  ...
  /// Creates an adaptive [YaruSwitch] based on whether the target platform is iOS
  ...
  /* const YaruSwitch.adaptive({ // Yaru change: bypass CupertinoSwitch
    Key? key,
    required this.value,
    required this.onChanged,
    this.activeColor,
  ...
  ///
  /// Ignored if this switch is created with [YaruSwitch.adaptive].
  ///
  ...
  /// The color of this [YaruSwitch]'s thumb.
  ///
  ...
  /// The color of this [YaruSwitch]'s track.
  ///
  /// Resolved in the following states:
  ///  * [MaterialState.selected].
  ///  * [MaterialState.hovered].
  ...
  /* Widget _buildCupertinoSwitch(BuildContext context) { // Yaru change: bypass CupertinoSwitch
  ...
  Widget build(BuildContext context) {
    /* switch (_switchType) { // Yaru change: bypass CupertinoSwitch
      case _SwitchType.material: */
    return _buildMaterialSwitch(context);

    /* case _SwitchType.adaptive: // Yaru change: bypass CupertinoSwitch
        {
